...
pub(crate) fn diff_exp(
    ...
    feature_ids
        ...
        .try_for_each(|(i, feature_id)| -> Result<()> {
            ...
            let max_prob_value2 = if max_prob_value2 != 0. { max_prob_value2 } else { N32::new(1.) };  // Avoid division by zero
            let max_prob_fold_change = *prob_dist_i_k1.get_max_prob_value().unwrap() / max_prob_value2;
